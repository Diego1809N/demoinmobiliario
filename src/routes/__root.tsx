...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "twitter:title", content: "Calio & Co — Inmobiliaria en Salta" },
      { name: "twitter:description", content: "Inmobiliaria en Salta capital. Compra, venta y alquiler de casas, departamentos, terrenos y locales en el NOA argentino." },
