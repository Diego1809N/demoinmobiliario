...
export const Route = createFileRoute("/nosotros")({
  head: () => ({
    meta: [
      { title: "Nosotros — Silvia Jaramillo Negocios Inmobiliarios" },
      { name: "description", content: "Conocé el equipo detrás de Silvia Jaramillo Negocios Inmobiliarios, inmobiliaria con sede en General Güemes, Salta." },
      { property: "og:title", content: "Sobre Silvia Jaramillo Negocios Inmobiliarios" },
  ...
  component: () => (
    <div className="min-h-screen flex flex-col">
      ...
      <PageHero
        ...
        description="Trabajamos junto a familias e inversores para concretar operaciones en General Güemes, Salta y el interior, con asesoramiento profesional de punta a punta."
      />
      ...
      <section className="mx-auto max-w-7xl px-4 sm:px-6 py-20 grid gap-12 lg:grid-cols-2 items-center">
        <img
          ...
          alt="Equipo de Silvia Jaramillo Negocios Inmobiliarios"
        ...
        <div>
          ...
          <p className="mt-4 text-muted-foreground">
            Silvia Jaramillo Negocios Inmobiliarios nació para profesionalizar el mercado inmobiliario en el NOA, con un servicio cercano, transparente y orientado a resultados. Hoy somos referentes en Salta por la confianza de cientos de familias e inversores.
          </p>
